"""
checkio elementary mission monkey typing
The infinite monkey theorem states that a monkey hitting keys at random 
on a typewriter keyboard for an infinite length of time will almost surely
type out a given text, such as the complete works of John Wallis, or more likely,
a Dan Brown novel.
...
"""
function find keys words in a text
"""
	# Return sum of key words in the text.
